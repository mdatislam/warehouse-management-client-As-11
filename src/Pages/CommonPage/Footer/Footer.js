  ...
  return (
    <div className='footer-container fixed="bottom" sticky="bottom" p-4 text-start'>
      <div className="info-container">
        ...
        <div>
          <h5>Contact Info</h5>
          <p> <FontAwesomeIcon  icon="fa-regular fa-location-dot" /> 92/2 Canopus Building, Rangpur Sadar,Rangpur</p>
          <p>+880132843476 | (02) 5437262</p>
          <p> <FontAwesomeIcon icon="fa-regular fa-envelope" /> info@warehouse.com | support@warehouse.com</p>
        </div>
        <div>
          <h5>Subscribe</h5>
